...
-- Dumping data for table db_bpsu_timesheet.auth_assignment: ~10 rows (approximately)
...
-- Dumping data for table db_bpsu_timesheet.auth_item: ~61 rows (approximately)
...
-- Dumping data for table db_bpsu_timesheet.auth_item_child: ~88 rows (approximately)
...
-- Dumping data for table db_bpsu_timesheet.files: ~4 rows (approximately)
...
-- Dumping data for table db_bpsu_timesheet.migration: ~8 rows (approximately)
...
-- Dumping data for table db_bpsu_timesheet.user: ~10 rows (approximately)
INSERT INTO `user` (`id`, `student_idno`, `student_year`, `student_section`, `ref_program_id`, `ref_program_major_id`, `ref_department_id`, `ref_position_id`, `fname`, `mname`, `sname`, `suffix`, `bday`, `sex`, `username`, `auth_key`, `password_hash`, `password_reset_token`, `email`, `mobile_no`, `tel_no`, `address`, `status`, `created_at`, `updated_at`, `verification_token`) VALUES
	...
	(35, '120994', 4, 'A', 1, 1, 2, NULL, 'John', '', 'Wick', '', '2005-04-01', 'M', 'trainee', 'AI1i1WwV90rEZNAmjGxS-rTYYrmtxZSy', '$2y$13$wjqWhWecWGBxWDNSErwqQeGbsd7EKKCTtOnDl64kl7q6u/6QybRqi', NULL, 'trainee@gm.com', 1234567890, '2343434', '031 Paris St, Brgy. Pinagbarilan, Bataan City', 10, 0, 0, 'wYE4Gfo3VfeF1blsL_VtQyiZUTrDY96o_1680313003'),
	(37, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'Elena', '', 'Wick', '', '2005-03-28', 'F', 'coor', 'kQcZ4MQ_0mncIcJdLY_G3yzqNegC3Udn', '$2y$13$EGGucJYrGZofQvza3X3tmOjxJyCv/hqJRlzso5Knxekwbbi26oddO', NULL, 'coor@gmi.com', 912323232, '23232323', '0934 something st.', 10, 0, 0, '0nXO9Xo1e9juosRRgY7T-h4Leaiq5xB2_1680313634'),
	(38, NULL, NULL, NULL, NULL, NULL, 1, 1, 'Lionel', '', 'Wick', '', '2005-03-30', 'M', 'super', 'XM5rIqW7oN9pajeCuNVNPv-OB-hUpEsW', '$2y$13$DCmmrQYvvuf2LjVqVLKp1e/ujon/S0V2ADz8GpdDej9Mvj8oRzvD2', NULL, 'super@gm.com', 912323232, '23232323', '2343 SOmething St.', 10, 0, 0, 'd1UVUsGwsvcpJoAFkw8KUNJaOipQLD3E_1680313693'),
	...
	(42, NULL, NULL, NULL, 2, NULL, NULL, NULL, 'coor2', '', 'coor2', 'II', '2005-03-31', 'M', 'coor2', 'Q0yEqPX_XTeI0I_ByGttvYKE0i18WMPm', '$2y$13$D/JvM87m5S/tcsHi1RIBfOzJA9c5fHPYy57Q2qMol/yEO.Pel1To6', NULL, 'coor2@gm.com', 901234904, '109023239032323', '12323 somewhere st.', 10, 0, 0, 'gt_BVFGfPbHp4yaicZCjV1CopZSGNVHa_1680316525'),
	(43, NULL, NULL, NULL, 4, NULL, NULL, NULL, 'coor3', '', 'coor3', '', '2005-03-30', 'F', 'coor3', '6WfvkgTJ_yKJgxFgQXkh_xxW23dYNcH4', '$2y$13$ZLQSI3sT9gn4QYkZwIQjRugDV3VZIw7jVi7QhvCib4Py/XUnHS96e', NULL, 'coor3@gm.com', 2147483647, '2343434', '6767 somewhere st.', 10, 0, 0, 'eE8y2WwtERlVjhgtb4VEB2PSNH6fB_lg_1680316634'),
	(44, '120993', 2, 'B', 5, NULL, 1, NULL, 'trainee2', 'trainee2', 'trainee2', '', '2005-04-01', 'F', 'trainee2', '2rEZW-2L1SKXcGtQH4WUoRSCSOtMz1EF', '$2y$13$nGNpo6D.zqSGmbx4000fMeGVJApmi2u3I4IY1ZPAFCfAWcvHOyziC', NULL, 'trainee2@gm.com', 912342403, '32535454344', '990 somewhere st.', 10, 0, 0, 'vlVLZ9RDQL34uLDqgL_Iz5RfWOG8MTEF_1680316868');
...
-- Dumping data for table db_bpsu_timesheet.user_company: ~11 rows (approximately)

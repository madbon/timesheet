...
INSERT INTO `user` (`id`, `student_idno`, `student_year`, `student_section`, `ref_program_id`, `ref_program_major_id`, `ref_company_id`, `ref_department_id`, `ref_position_id`, `fname`, `mname`, `sname`, `suffix`, `bday`, `sex`, `username`, `auth_key`, `password_hash`, `password_reset_token`, `email`, `mobile_no`, `tel_no`, `address`, `status`, `created_at`, `updated_at`, `verification_token`) VALUES
	...
	(21, '2313553', 4, 'B', 1, NULL, NULL, NULL, NULL, 'vilma', '', 'dayagmil', '', '2005-03-06', 'M', 'vilma', 'bQW83W97gNRv8h_OLOQQEcBKt82ZKDtG', '$2y$13$p12B2eY8FRiAArUz1ONr7.bugwXDqwfCjh7diU2YcVSc.BYIbHJQ6', NULL, 'vilma@gm.com', 9232323, 'sdfdf', 'sdfdfd', 10, 0, 0, 'mEhL6bWT6Dms3Cs8-jvfRt8N-D9OqWPL_1678677395'),
	(22, '234343', 4, 'E', 4, NULL, NULL, NULL, NULL, 'france', '', 'dacales', '', '2005-02-28', 'F', 'france', 'LEH7yRVrvsCkfYGvvykGSekyD_gq3q5S', '$2y$13$oqmSvq5yfCPHkOARf8Wyye5s4WnZjXJ8ilMdqmgFWjXT9hQah8LSK', NULL, 'france@gm.com', 2147483647, '2343434', 'sdfdfd', 10, 0, 0, 'NuE-OGiB9RnY3zRC6Qe7OGar1-Up5vrx_1678677582'),
	...
	(28, '890232', 4, 'A', 5, NULL, NULL, NULL, NULL, 'Genese', '', 'Luna', '', '2005-03-15', 'F', 'genluna', 'PiowCQ7Fw-U9np-bROC2IsXvT9S2SY0I', '$2y$13$JItdkwe.rjAQqV2ofRJjaeVIp4afiNwBxxov3/CcHWgQ5k/TTMYQ6', NULL, 'genluna@gm.com', 923239232, '123-1232', 'Bocaue, Bulacan', 10, 0, 0, 'Nstb34KJO89hoarjamjI6F0WwMGrhSy9_1678847596');
...
-- Dumping data for table db_bpsu_timesheet.user_company: ~5 rows (approximately)
INSERT INTO `user_company` (`id`, `user_id`, `latitude`, `longitude`, `name`, `address`, `contact_info`, `ref_company_id`) VALUES
	(1, 18, 14.644715, 121.036745, 'DILG-NAPOLCOM Center', 'DILG-NAPOLCOM Center, Edsa Corner Quezon Avenue, Lungsod Quezon, Kalakhang Maynila, Pilipinas', '1231-232-3232, 425-2324, 912-7890', 17),
	(2, 20, 14.556036, 121.054171, 'Accenture Uptown Mall BGC Tower 2 Office', 'Accenture Uptown Mall BGC Tower 2 Office, Taguig, Kalakhang Maynila, Pilipinas', '783-2323', 1),
	(3, 21, 14.658211, 121.057707, 'Manulife Business Processing Services Main Building', 'Manulife Business Processing Services Main Building, Diliman, Lungsod Quezon, Kalakhang Maynila, Pilipinas', '234-23232, manulife@gm.com, 0912-3456-789', 2),
	(4, 22, 14.644715, 121.036745, 'DILG-NAPOLCOM Center', 'DILG-NAPOLCOM Center, Edsa Corner Quezon Avenue, Lungsod Quezon, Kalakhang Maynila, Pilipinas', '243-43434', 4),
	(5, 28, NULL, NULL, NULL, NULL, NULL, 3);

...
-- Dumping data for table db_bpsu_timesheet.auth_item_child: ~78 rows (approximately)
...
-- Dumping data for table db_bpsu_timesheet.files: ~55 rows (approximately)
...
-- Dumping data for table db_bpsu_timesheet.user_timesheet: ~9 rows (approximately)

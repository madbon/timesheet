...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='This table would allow you to store announcement details/content.';

-- Dumping data for table db_bpsu_timesheet.announcement: ~4 rows (approximately)
INSERT INTO `announcement` (`id`, `viewer_type`, `user_id`, `content_title`, `content`, `date_time`) VALUES
	...
	(2, 'all_program', 37, '', 'sadsfdf', '2023-05-05 13:55:08'),
	(3, 'all_program', 37, '', 'sample announcement for john wick', '2023-05-07 21:40:45'),
	(4, 'assigned_program', 37, '', 'announcement for assigned courses', '2023-05-07 21:41:39');
...
CREATE TABLE IF NOT EXISTS `announcement_program_tags` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='This table will store data on which courses/programs will see the announcement';
...
-- Dumping data for table db_bpsu_timesheet.announcement_seen: ~4 rows (approximately)
INSERT INTO `announcement_seen` (`id`, `announcement_id`, `user_id`, `date_time`) VALUES
	(1, 4, 35, NULL),
	(11, 3, 35, '2023-05-07 18:18:08'),
	(12, 2, 35, '2023-05-07 18:18:26'),
	(13, 1, 35, '2023-05-07 18:18:26');
...
-- Dumping data for table db_bpsu_timesheet.auth_item_child: ~103 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=329 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='in this table you can see all the files uploaded to the system';

-- Dumping data for table db_bpsu_timesheet.files: ~117 rows (approximately)
INSERT INTO `files` (`id`, `user_id`, `model_name`, `model_id`, `file_name`, `extension`, `file_hash`, `remarks`, `created_at`, `user_timesheet_time`, `user_timesheet_id`) VALUES
	...
	(246, 35, 'UserTimesheet', 35, '6443d7bd5e806.png', 'png', '6443d7bd5e806.png', NULL, 1682167741, '20:49:01', 39),
	(269, 35, 'UserTimesheet', 35, '644402982fe8f.png', 'png', '644402982fe8f.png', NULL, 1682178712, '23:51:52', 57),
	(270, 35, 'UserTimesheet', 35, '64454bcb35bbb.png', 'png', '64454bcb35bbb.png', NULL, 1682262987, '23:16:27', 58),
	(271, 35, 'UserTimesheet', 35, '64454be3db73f.png', 'png', '64454be3db73f.png', NULL, 1682263011, '23:16:51', 58),
	(272, 35, 'SubmissionReply', 1, 'Sulat to Capt. Maning Co re Lupa 3 versions', 'pdf', '008030fb283130d84ad333adc21a0234', NULL, 1682302471, NULL, NULL),
	(273, 35, 'SubmissionThread', 5, 'Sulat to Capt. Maning Co re Lupa 3 versions', 'pdf', '790847dd290f0bb0926c79fc65c12dc6', NULL, 1682319030, NULL, NULL),
	(274, 35, 'SubmissionThread', 6, 'BON, LEONEL REY D. - CV', 'pdf', 'bc3d055ee5cd4477809d79ff1e043571', NULL, 1682403881, NULL, NULL),
	(275, 35, 'UserTimesheet', 35, '6448b3e83628d.png', 'png', '6448b3e83628d.png', NULL, 1682486248, '13:17:28', 59),
	(276, 35, 'UserTimesheet', 35, '6448b41072a9f.png', 'png', '6448b41072a9f.png', NULL, 1682486288, '13:18:08', 59),
	(285, 35, 'UserTimesheet', 35, '6448be46c1522.png', 'png', '6448be46c1522.png', NULL, 1682488902, '14:01:42', 68),
	(286, 35, 'SubmissionThread', 7, 'Sulat to Capt. Maning Co re Lupa 3 versions', 'pdf', '0084d21a9c2fb86cfe69da804eb189c2', NULL, 1682489865, NULL, NULL),
	(311, 35, 'UserTimesheet', 35, '6450c515c5e23.png', 'png', '6450c515c5e23.png', NULL, 1683014933, '16:08:53', 91),
	(312, 35, 'SubmissionThread', 9, 'Authentication', 'pdf', '14bb0e247ac232e854df6f3ec570f927', NULL, 1683074619, NULL, NULL),
	(313, 83, 'UserFacialRegister', 83, '6451e257b676f.png', 'png', '6451e257b676f.png', NULL, 1683087959, NULL, NULL),
	(314, 83, 'UserFacialRegister', 83, '6451e25ce81d6.png', 'png', '6451e25ce81d6.png', NULL, 1683087964, NULL, NULL),
	(315, 83, 'UserFacialRegister', 83, '6451e25fafe46.png', 'png', '6451e25fafe46.png', NULL, 1683087967, NULL, NULL),
	(316, 83, 'UserFacialRegister', 83, '6451e261e92e3.png', 'png', '6451e261e92e3.png', NULL, 1683087969, NULL, NULL),
	(317, 83, 'UserFacialRegister', 83, '6451e2668563b.png', 'png', '6451e2668563b.png', NULL, 1683087974, NULL, NULL),
	(318, 83, 'UserFacialRegister', 83, '6451e268ebc18.png', 'png', '6451e268ebc18.png', NULL, 1683087976, NULL, NULL),
	(319, 83, 'UserFacialRegister', 83, '6451e27ac3b4a.png', 'png', '6451e27ac3b4a.png', NULL, 1683087994, NULL, NULL),
	(320, 83, 'UserFacialRegister', 83, '6451e2804bc3c.png', 'png', '6451e2804bc3c.png', NULL, 1683088000, NULL, NULL),
	(321, 83, 'UserFacialRegister', 83, '6451e283dd33d.png', 'png', '6451e283dd33d.png', NULL, 1683088003, NULL, NULL),
	(322, 83, 'UserFacialRegister', 83, '6451e28891fad.png', 'png', '6451e28891fad.png', NULL, 1683088008, NULL, NULL),
	(323, 83, 'UserFacialRegister', 83, '6451e290e00e7.png', 'png', '6451e290e00e7.png', NULL, 1683088016, NULL, NULL),
	(324, 83, 'UserFacialRegister', 83, '6451e293387a6.png', 'png', '6451e293387a6.png', NULL, 1683088019, NULL, NULL),
	(325, 83, 'UserFacialRegister', 83, '6451e29b723d8.png', 'png', '6451e29b723d8.png', NULL, 1683088027, NULL, NULL),
	(326, 37, 'Announcement', 2, '15714134546_79079bb096_k', 'jpg', '69912b454fc16712647ca311886021cf', NULL, 1683266108, NULL, NULL),
	(327, 37, 'Announcement', 2, '17364160955_3f16343c04_k', 'jpg', '30932740298320b6b5f511cabd461336', NULL, 1683266108, NULL, NULL),
	(328, 38, 'UserData', 38, 'esig4', 'png', 'cc8245255ca90eefd01d9d43e2a1292d', NULL, 1683270141, NULL, NULL);
...
-- Dumping data for table db_bpsu_timesheet.migration: ~13 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='transaction table: this table allows user to store messages/comment regarding the submitted document (AR) or performed tasks (creating activity reminder) (messenger)';

-- Dumping data for table db_bpsu_timesheet.submission_reply: ~23 rows (approximately)
INSERT INTO `submission_reply` (`id`, `submission_thread_id`, `user_id`, `message`, `date_time`) VALUES
	(1, 4, 35, 'hey brother', '2023-04-24 12:01:46'),
	(4, 4, 35, 'just want to follow brother', '2023-04-24 14:43:10'),
	(5, 4, 35, 'Please send me reply', '2023-04-24 14:43:27'),
	(6, 4, 35, 'At least you have seen it', '2023-04-24 14:45:04'),
	(7, 1, 35, 'brother check also this', '2023-04-24 14:45:18'),
	(8, 5, 35, 'hello po', '2023-04-25 12:07:13'),
	(9, 5, 37, 'Yes?', '2023-04-25 12:35:23'),
	(10, 5, 37, 'ano un?', '2023-04-25 12:37:01'),
	(11, 1, 35, 'did you check this?', '2023-04-25 12:46:00'),
	(12, 1, 37, 'Yes, I\'m sorry', '2023-04-25 12:46:37'),
	(13, 1, 35, 'Hi guys', '2023-04-25 13:06:43'),
	(14, 5, 35, 'kase ganto un', '2023-04-25 13:08:40'),
	(15, 5, 35, 'weh?', '2023-04-25 13:10:12'),
	(16, 5, 37, 'Oo nga', '2023-04-25 13:10:35'),
	(17, 5, 35, 'yes boss?', '2023-04-25 13:38:10'),
	(18, 5, 37, 'yes?', '2023-04-25 14:00:13'),
	(19, 5, 35, 'yes yes?', '2023-04-25 14:10:01'),
	(20, 5, 35, 'yes?', '2023-04-25 14:10:26'),
	(21, 5, 37, 'ano un yess?', '2023-04-25 14:19:38'),
	(22, 5, 37, 'and wait yess?', '2023-04-25 14:19:44'),
	(23, 5, 37, 'yesyes yow', '2023-04-25 14:22:42'),
	(24, 6, 35, 'submit ko yan boss', '2023-04-25 14:27:10'),
	(25, 7, 35, 'by the way I forget to tell you', '2023-04-26 14:27:01');
...
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='here you can see if the user has seen the reply or message regarding the AR submission';

-- Dumping data for table db_bpsu_timesheet.submission_reply_seen: ~46 rows (approximately)
INSERT INTO `submission_reply_seen` (`id`, `submission_thread_id`, `submission_reply_id`, `user_id`, `date_time`) VALUES
	(1, 4, 1, 35, '2023-04-24 12:01:46'),
	(10, 4, 4, 35, '2023-04-24 14:43:10'),
	(11, 4, 5, 35, '2023-04-24 14:43:27'),
	(12, 4, 1, 37, '2023-04-24 08:43:59'),
	(13, 4, 4, 37, '2023-04-24 08:43:59'),
	(14, 4, 5, 37, '2023-04-24 08:43:59'),
	(15, 4, 6, 35, '2023-04-24 14:45:04'),
	(16, 1, 7, 35, '2023-04-24 14:45:18'),
	(17, 1, 7, 37, '2023-04-24 14:45:43'),
	(18, 5, 8, 35, '2023-04-25 12:07:13'),
	(19, 5, 8, 37, '2023-04-25 06:21:55'),
	(20, 4, 6, 37, '2023-04-25 06:22:00'),
	(21, 5, 9, 37, '2023-04-25 12:35:23'),
	(22, 5, 10, 37, '2023-04-25 12:37:01'),
	(23, 5, 9, 35, '2023-04-25 06:44:34'),
	(24, 5, 10, 35, '2023-04-25 06:44:34'),
	(25, 1, 11, 35, '2023-04-25 12:46:00'),
	(26, 1, 11, 37, '2023-04-25 06:46:22'),
	(27, 1, 12, 37, '2023-04-25 12:46:37'),
	(28, 1, 12, 35, '2023-04-25 06:46:44'),
	(29, 1, 13, 35, '2023-04-25 13:06:43'),
	(30, 1, 13, 37, '2023-04-25 07:06:53'),
	(31, 5, 14, 35, '2023-04-25 13:08:40'),
	(32, 5, 14, 37, '2023-04-25 07:09:55'),
	(33, 5, 15, 35, '2023-04-25 13:10:12'),
	(34, 5, 15, 37, '2023-04-25 07:10:31'),
	(35, 5, 16, 37, '2023-04-25 13:10:35'),
	(36, 5, 16, 35, '2023-04-25 07:38:04'),
	(37, 5, 17, 35, '2023-04-25 13:38:10'),
	(38, 5, 17, 37, '2023-04-25 07:59:58'),
	(39, 5, 18, 37, '2023-04-25 14:00:13'),
	(40, 5, 18, 35, '2023-04-25 08:00:50'),
	(41, 5, 19, 35, '2023-04-25 14:10:01'),
	(42, 5, 20, 35, '2023-04-25 14:10:26'),
	(43, 5, 19, 37, '2023-04-25 08:19:32'),
	(44, 5, 20, 37, '2023-04-25 08:19:32'),
	(45, 5, 21, 37, '2023-04-25 14:19:38'),
	(46, 5, 22, 37, '2023-04-25 14:19:44'),
	(47, 5, 21, 35, '2023-04-25 08:19:59'),
	(48, 5, 22, 35, '2023-04-25 08:19:59'),
	(49, 5, 23, 37, '2023-04-25 14:22:42'),
	(50, 5, 23, 35, '2023-04-25 08:24:06'),
	(51, 6, 24, 35, '2023-04-25 14:27:10'),
	(52, 6, 24, 37, '2023-04-26 13:15:03'),
	(53, 7, 25, 35, '2023-04-26 14:27:01'),
	(54, 7, 25, 37, '2023-05-03 08:42:17');
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='transactional table: here you can store all transaction regarding the tasks or submission of Accomplishment Report, Evaluation Form, and Activity Reminder.';

-- Dumping data for table db_bpsu_timesheet.submission_thread: ~9 rows (approximately)
INSERT INTO `submission_thread` (`id`, `user_id`, `tagged_user_id`, `subject`, `remarks`, `ref_document_type_id`, `created_at`, `date_time`) VALUES
	...
	(5, 35, NULL, NULL, 'Submissoon for the month of January', 3, 1682319030, '2023-04-24 14:50:30'),
	(6, 35, NULL, NULL, 'submit ko ulet to', 3, 1682403881, '2023-04-25 14:24:41'),
	(7, 35, NULL, NULL, 'Here\'s my AR for March', 3, 1682489865, '2023-04-26 14:17:45'),
	(8, 38, NULL, NULL, 'Activity for today', 5, 1683073472, '2023-05-03 08:24:32'),
	(9, 35, NULL, NULL, '', 3, 1683074619, '2023-05-03 08:43:39');
...
INSERT INTO `submission_thread_seen` (`id`, `submission_thread_id`, `user_id`, `date_time`) VALUES
	...
	(2, 4, 37, '2023-04-24 13:40:11'),
	(3, 2, 37, '2023-04-24 14:45:36'),
	(4, 1, 37, '2023-04-24 14:45:43'),
	(5, 5, 37, '2023-04-24 14:54:56'),
	(6, 6, 37, '2023-04-26 13:15:03'),
	(7, 7, 37, '2023-05-03 08:42:17');
...
) ENGINE=InnoDB AUTO_INCREMENT=84 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='List of users of the system';

-- Dumping data for table db_bpsu_timesheet.user: ~25 rows (approximately)
INSERT INTO `user` (`id`, `student_idno`, `student_year`, `student_section`, `ref_program_id`, `ref_program_major_id`, `ref_department_id`, `ref_position_id`, `fname`, `mname`, `sname`, `suffix`, `bday`, `sex`, `username`, `auth_key`, `password_hash`, `password_reset_token`, `email`, `mobile_no`, `tel_no`, `address`, `status`, `created_at`, `updated_at`, `verification_token`) VALUES
	...
	(35, '19-01905', 4, 'A', 1, 3, 1, NULL, 'John', '', 'Wick', '', '2005-04-01', 'M', 'johnwick', 'AI1i1WwV90rEZNAmjGxS-rTYYrmtxZSy', '$2y$13$ap2M63KGZc2Z4jsgRiN71eMDSwyRRfcb/fs/fOAKLxTw5CzMjstX2', NULL, 'trainee@gm.com', '1234567890', '2343434', '031 Paris St, Brgy. Pinagbarilan, Bataan City', 10, 0, 0, 'wYE4Gfo3VfeF1blsL_VtQyiZUTrDY96o_1680313003'),
	...
	(44, '120993', 4, 'B', 1, 3, 1, NULL, 'Leonardo', '', 'Carpio', '', '2005-04-01', 'F', 'leonardo', '2rEZW-2L1SKXcGtQH4WUoRSCSOtMz1EF', '$2y$13$fQeUXPxCvdcLJa2fwyAUFu8eP6xnpJX5YbAAdBVJ5qhbdMJn7YvRu', NULL, 'trainee2@gm.com', '912342403', '32535454344', '990 somewhere st.', 9, 0, 0, 'vlVLZ9RDQL34uLDqgL_Iz5RfWOG8MTEF_1680316868'),
	...
	(46, '120995', 4, 'C', 2, 0, 1, NULL, 'Myrna', '', 'Reyes', '', '2005-03-08', 'F', 'myrnareyes', 'PGYJmmpl_4i_kkJXA-g3PFMRw6mO43lC', '$2y$13$n2UEn4hRsJ6lWKaxudIPl.8IL/CHm0aSJ5j.izgIiq.RChx9h0Ghy', NULL, 'trainee3@gm.com', '920903290', '123-2323', '94556 somewhere st.', 9, 0, 0, '7y_t9frc6TACW60MjXqPdsfEHc5N80b__1680435026'),
	...
	(76, '19-01905', 4, 'A', 1, 3, NULL, NULL, 'Jhaema', 'Santos', 'Nicdao', NULL, '2000-09-05', 'M', '19-01905', '', '$2y$13$moA/QfJyF0u8jjfcSfq2NOTT4XgpcNNY0pvMvxW/EqgKN5FgvBTV6', NULL, 'jsnicdao@bpsu.edu.ph', '2147483647', '', '033B Somewhere St.', 10, 0, 0, NULL),
	(77, '19-05009', 4, 'A', 1, 3, NULL, NULL, 'Ericka Eunice', 'Dalampasig', 'Catalan', NULL, '2001-06-24', 'F', '19-05009', '', '$2y$13$fXQENeWMgQP7J6urqn0ao.V8eLadGaD5DC1zEdZTkA8NLyG6bFeES', NULL, 'eedcatalan@bpsu.edu.ph', '2147483647', '', '031B Somewhere St.', 10, 0, 0, NULL),
	(78, '19-03547', 4, 'A', 1, 3, NULL, NULL, 'Nick John', 'Gonzales', 'Gloria', NULL, '2001-07-05', 'F', '19-03547', '', '$2y$13$ZVv0oQc7FDBEpw2ryCNjruEYRVIRiexh.PaAJp4VFMpN0384TgBpy', NULL, 'njggloria@bpsu.edu.ph', '2147483647', '', '030B Somewhere St.', 10, 0, 0, NULL),
	(79, '19-04831', 4, 'A', 1, 3, NULL, NULL, 'Christian Jay', 'Nival', 'Tuyor', NULL, '2001-07-19', 'F', '19-04831', '', '$2y$13$XxWlslZLzJO0CSfZkAIVrOfEndqasWKLUpsamh.wSTSQQGlhCcnY.', NULL, 'cjntuyor@bpsu.edu.ph', '2147483647', '', '042B Somewhere St.', 10, 0, 0, NULL),
	(80, '890899', 4, 'B', 1, 3, 2, NULL, 'Mark Angelo', 'Dayagmil', 'Bon', '', '2005-05-02', 'M', 'bonmarkangelo', 'JppsRgud8dKtVvXsvFsB8-laTMJc4iQP', '$2y$13$KHiqUCPlsLTqTMC1O.SZYOzmMK91sEHa3pNJbFkgqLxnpFqz9rOG2', NULL, 'bonmarkangelo@gm.com', '912222222', '09092323', '09019 fdfdklk', 10, 0, 0, 'iyITxNiQFWviBIJV9BK8X9O9qFZgvkEv_1683016081'),
	(81, '2134343', 4, 'A', 2, 0, 1, NULL, 'Deniel', '', 'Maomay', '', '2005-05-02', 'M', 'denielmaomay', 'cDC9bFeeevLDHWeLYpFqF6o3WkdS3WLb', '$2y$13$Nsgy1Q7mUmPeESG0cjLlPeY7LR88RpNjmOS/QQFXdpjWVolnj6fRe', NULL, 'denielmaomay@g.com', '910000000', '232-3232', '0902 kjlkjsdf', 10, 0, 0, 'j0MchE6ek5pxeuMnf4CizWOjO73LCUZy_1683016208'),
	(82, NULL, NULL, NULL, NULL, 0, NULL, NULL, 'Dennis', '', 'Rodman', '', '2005-05-02', 'M', 'dennisrodman', '8eZ1ObEiNa7NVbHKE06v7Y4SM5vnHFKq', '$2y$13$XSRfvE/h9eEYtS8.ygeBMe9OoJmxy6DI/GTXb0IOJtz.fDdRN84.S', NULL, 'dennisrodman@gm.com', '9202020202', '089-23232', '32434 fdsfdfdf', 10, 0, 0, 'cQqDjyBUhouaE1O_C8dkVM2dx-w4gMsT_1683016611'),
	(83, '1210999', 3, 'B', 1, 3, 1, NULL, 'Kennedy', '', 'Mateo', '', '2005-05-03', 'M', 'kennedy123', 'c9sNbFOeOZmZy9_gAr1cZSy1eIn0jyy7', '$2y$13$Z/Ty5bKxp8fqB//hS1z4mubo8KcIXR6gzPev.pJQroPeXd11rpZHO', NULL, 'kennedy123@gm.com', '0912828282', '', '033 something street', 10, 0, 0, 'P-qDD2JtfMzx0oM53kxPNcT5jqs2CbKd_1683087927');
...
-- Dumping data for table db_bpsu_timesheet.user_archive: ~12 rows (approximately)
INSERT INTO `user_archive` (`id`, `user_id`, `user_status`, `date_time`) VALUES
	(1, 35, 9, '2023-04-23 22:03:00'),
	(2, 44, 9, '2023-04-23 22:03:00'),
	(3, 46, 9, '2023-04-23 22:03:00'),
	(4, 64, 9, '2023-04-23 22:03:00'),
	(5, 64, 10, '2023-04-23 22:05:25'),
	(6, 35, 10, '2023-04-23 22:24:43'),
	(7, 35, 9, '2023-04-23 22:24:49'),
	(8, 35, 10, '2023-04-23 22:28:30'),
	(9, 35, 9, '2023-04-23 23:12:44'),
	(10, 35, 10, '2023-04-23 23:16:08'),
	(11, 35, 9, '2023-04-27 12:48:27'),
	(12, 35, 10, '2023-04-28 20:23:50');
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='List of users (trainee and supervisor) assigned company';

-- Dumping data for table db_bpsu_timesheet.user_company: ~19 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `user_timesheet` (
  ...
  KEY `id` (`id`),
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=92 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='This table serves as storage of time in/out that displays in the DTR of trainee';

-- Dumping data for table db_bpsu_timesheet.user_timesheet: ~19 rows (approximately)
INSERT INTO `user_timesheet` (`id`, `user_id`, `time_in_am`, `time_out_am`, `time_in_pm`, `time_out_pm`, `date`, `remarks`, `status`) VALUES
	(1, 35, '08:00:00', '10:00:00', NULL, NULL, '2023-03-08', NULL, 1),
	(2, 35, '10:30:00', '11:40:00', '13:00:00', '19:00:00', '2023-03-08', NULL, 1),
	(4, 35, '08:11:34', '09:20:41', '13:53:48', '20:57:56', '2023-04-09', NULL, 0),
	(5, 35, NULL, NULL, '13:15:04', '21:48:59', '2023-04-09', NULL, 0),
	...
	(17, 35, '08:07:03', '11:59:40', NULL, NULL, '2023-04-13', NULL, 0),
	(18, 35, '10:10:02', '10:10:33', NULL, NULL, '2023-04-13', NULL, 0),
	(38, 35, '08:00:00', NULL, NULL, '15:00:00', '2023-04-22', NULL, 0),
	(39, 35, NULL, NULL, '17:00:00', '20:00:00', '2023-04-22', NULL, 0),
	(58, 35, NULL, NULL, '23:16:27', '23:16:51', '2023-04-23', NULL, 0),
	(59, 35, NULL, NULL, '13:17:28', '13:18:08', '2023-04-26', NULL, 0),
	(68, 35, NULL, NULL, '14:01:42', NULL, '2023-04-26', NULL, 0),
	(91, 35, NULL, NULL, '16:08:53', NULL, '2023-05-02', NULL, 0);

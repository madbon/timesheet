...
) ENGINE=InnoDB AUTO_INCREMENT=326 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='in this table you can see all the files uploaded to the system';
...
-- Dumping data for table db_bpsu_timesheet.submission_reply: ~22 rows (approximately)
...
-- Dumping data for table db_bpsu_timesheet.submission_reply_seen: ~45 rows (approximately)
...
-- Dumping data for table db_bpsu_timesheet.user_archive: ~10 rows (approximately)
...
-- Dumping data for table db_bpsu_timesheet.user_timesheet: ~37 rows (approximately)
INSERT INTO `user_timesheet` (`id`, `user_id`, `time_in_am`, `time_out_am`, `time_in_pm`, `time_out_pm`, `date`, `remarks`, `status`) VALUES
	(1, 35, '08:00:00', '10:00:00', NULL, NULL, '2023-03-08', NULL, 0),
	(2, 35, '10:30:00', '11:40:00', '13:00:00', '17:00:00', '2023-03-08', NULL, 0),
	...
	(39, 35, '11:04:53', '11:09:50', '18:54:58', '20:49:01', '2023-04-22', NULL, 0),
	(57, 35, NULL, NULL, '23:51:52', NULL, '2023-04-22', NULL, 0),

...
-- Dumping data for table db_bpsu_timesheet.files: ~80 rows (approximately)
INSERT INTO `files` (`id`, `user_id`, `model_name`, `model_id`, `file_name`, `extension`, `file_hash`, `remarks`, `created_at`) VALUES
	...
	(80, 31, 'SubmissionThread', 8, 'EVALUATION FORM', 'pdf', 'a0c98ae0c7337e9a7541de37ec4b1b7c', NULL, 1680012041),
	(81, 31, 'SubmissionThread', 9, 'EVALUATION FORM', 'pdf', 'aeb96ae70d450d480f56157e273d1e3c', NULL, 1680012255),
	(82, 31, 'SubmissionThread', 4, 'Sample Document', 'pdf', '5f0584cab727956077ded4befbe79131', NULL, 1680014353);
...
INSERT INTO `ref_document_type` (`id`, `title`, `action_title`, `required_uploading`, `enable_tagging`) VALUES
	(1, 'Trainees Evaluation Form', 'Submit Trainees Evaluation Form', 1, 1),
	(3, 'Accomplishment Report', 'Submit Accomplishment Report', 1, 0),
	(5, 'Activity Reminder', 'Create Activity Reminder', 0, 0);

...
-- Dumping data for table db_bpsu_timesheet.auth_assignment: ~25 rows (approximately)
...
-- Dumping data for table db_bpsu_timesheet.auth_item: ~75 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=275 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='in this table you can see all the files uploaded to the system';
...
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='here you can see if the user has seen the reply or message regarding the AR submission';

-- Dumping data for table db_bpsu_timesheet.submission_reply_seen: ~43 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `submission_thread_seen` (
  ...
  KEY `submission_thread_id` (`submission_thread_id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Transactional table: serves as basis if the user seen the submitted document or viewed the created activity reminder';

-- Dumping data for table db_bpsu_timesheet.submission_thread_seen: ~5 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='List of users of the system';
...
INSERT INTO `user` (`id`, `student_idno`, `student_year`, `student_section`, `ref_program_id`, `ref_program_major_id`, `ref_department_id`, `ref_position_id`, `fname`, `mname`, `sname`, `suffix`, `bday`, `sex`, `username`, `auth_key`, `password_hash`, `password_reset_token`, `email`, `mobile_no`, `tel_no`, `address`, `status`, `created_at`, `updated_at`, `verification_token`) VALUES
	...
	(72, '19-01905', 4, 'A', 4, NULL, NULL, NULL, 'Jhaema', 'Santos', 'Nicdao', NULL, '2000-09-05', 'M', '19-01905', '', '$2y$13$13JUN54xK3Q71hOkW7iZsuQ5V.BfZS5.MKnY3JSloxyAYsFoJkHUC', NULL, 'jsnicdao@bpsu.edu.ph', 2147483647, '', '033B Somewhere St.', 10, 0, 0, NULL),
	(73, '19-05009', 4, 'A', 4, NULL, NULL, NULL, 'Ericka Eunice', 'Dalampasig', 'Catalan', NULL, '2001-06-24', 'F', '19-05009', '', '$2y$13$wO8l46ca57HL8rgBwODT6eF2p395YanaTRX6FGgxcW.OOVsi5WYHy', NULL, 'eedcatalan@bpsu.edu.ph', 2147483647, '', '031B Somewhere St.', 10, 0, 0, NULL),
	(74, '19-03547', 4, 'A', 4, NULL, NULL, NULL, 'Nick John', 'Gonzales', 'Gloria', NULL, '2001-07-05', 'F', '19-03547', '', '$2y$13$K6bVq2OXtZvkk.p7fGB83uguSok0I7QbfC5oBa/OdzBka8.hZ/UB.', NULL, 'njggloria@bpsu.edu.ph', 2147483647, '', '030B Somewhere St.', 10, 0, 0, NULL),
	(75, '19-04831', 4, 'A', 4, NULL, NULL, NULL, 'Christian Jay', 'Nival', 'Tuyor', NULL, '2001-07-19', 'F', '19-04831', '', '$2y$13$rB141LyI0fYESqH/mQ93d.AwpZYGebQoDkfHSIyMRFnYIEJ8OXpUu', NULL, 'cjntuyor@bpsu.edu.ph', 2147483647, '', '042B Somewhere St.', 10, 0, 0, NULL);
...
CREATE TABLE IF NOT EXISTS `user_timesheet` (
  ...
  KEY `id` (`id`),
  KEY `status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='This table serves as storage of time in/out that displays in the DTR of trainee';

-- Dumping data for table db_bpsu_timesheet.user_timesheet: ~34 rows (approximately)

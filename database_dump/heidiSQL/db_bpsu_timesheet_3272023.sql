...
-- Dumping data for table db_bpsu_timesheet.auth_item: ~58 rows (approximately)
...
-- Dumping data for table db_bpsu_timesheet.auth_item_child: ~84 rows (approximately)
...
-- Dumping data for table db_bpsu_timesheet.files: ~70 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `ref_document_type` (
  ...
  `type` varchar(10) DEFAULT NULL COMMENT 'Receiver or Sender',
  `auth_item_name` varchar(50) DEFAULT NULL,
  `required_uploading` varchar(3) DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table db_bpsu_timesheet.ref_document_type: ~6 rows (approximately)
INSERT INTO `ref_document_type` (`id`, `title`, `type`, `auth_item_name`, `required_uploading`) VALUES
	(1, 'TRAINEES_EVALUATION', 'SENDER', 'CompanySupervisor', 'YES'),
	(2, 'TRAINEES_EVALUATION', 'RECEIVER', 'OjtCoordinator', 'NO'),
	(3, 'ACCOMPLISHMENT_REPORT', 'SENDER', 'Trainee', 'YES'),
	(4, 'ACCOMPLISHMENT_REPORT', 'RECEIVER', 'OjtCoordinator', 'NO'),
	(5, 'ACTIVITY_REMINDER', 'SENDER', 'CompanySupervisor', 'NO'),
	(6, 'ACTIVITY_REMINDER', 'RECEIVER', 'Trainee', 'NO');
...
INSERT INTO `submission_thread` (`id`, `user_id`, `subject`, `remarks`, `ref_document_type_id`, `created_at`, `date_time`) VALUES
	(13, 31, 'Trainees Evaluation Form of BPSU', 'If you are going to use a passage of Lorem Ipsum, you need to be sure there isn\'t anything embarrassing hidden in the middle of text. \r\n\r\nAll the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet', 1, 1679836155, '2023-03-26 21:09:15'),
	(14, 31, 'Task for next week', 'We will have a preventive maintenance on computers inside the communication department. Please assist us.', 5, 1679843905, '2023-03-26 23:18:25');

...
-- Dumping data for table db_bpsu_timesheet.auth_assignment: ~34 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=129 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci COMMENT='in this table you can see all the files uploaded to the system';

-- Dumping data for table db_bpsu_timesheet.files: ~95 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='transactional table: here you can store all transaction regarding the tasks or submission of Accomplishment Report, Evaluation Form, and Activity Reminder.';
...
-- Dumping data for table db_bpsu_timesheet.user_company: ~17 rows (approximately)
...
INSERT INTO `user_timesheet` (`id`, `user_id`, `time_in_am`, `time_out_am`, `time_in_pm`, `time_out_pm`, `date`, `remarks`, `status`) VALUES
	...
	(2, 87, '09:12:32', NULL, NULL, NULL, '2023-04-27', 'earthquake drill', 0),
	(3, 87, NULL, NULL, '17:06:52', '19:55:53', '2023-04-28', NULL, 0),
	(4, 87, NULL, NULL, NULL, NULL, '2023-04-03', 'Holiday for example', 0),
	...
	(22, 87, NULL, NULL, NULL, NULL, '2023-05-24', 'Sample holiday', 0),
	(24, 87, NULL, NULL, NULL, NULL, '2023-05-29', 'sample', 0),
	(25, 87, NULL, NULL, NULL, NULL, '2023-05-30', 'sample holiday kaibigan', 0),
	(26, 87, '10:28:51', '11:29:04', NULL, NULL, '2023-04-22', 'sample holiday in 22 s', 0),
	(27, 87, NULL, NULL, '13:45:06', '13:45:14', '2023-05-13', 'Holiday', 0),
	(29, 87, NULL, NULL, '13:45:21', '13:45:31', '2023-05-13', NULL, 0);

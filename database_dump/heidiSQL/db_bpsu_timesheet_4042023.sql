...
-- Dumping data for table db_bpsu_timesheet.announcement: ~6 rows (approximately)
INSERT INTO `announcement` (`id`, `viewer_type`, `user_id`, `content_title`, `content`, `date_time`) VALUES
	(1, 'assigned_program', 2, 'To All BSIT', ' Dear students, please be informed that the deadline for submitting your final project has been extended to April 20th. Make sure to use this extra time wisely and reach out to your instructors if you need any assistance.', '2023-04-04 10:45:41'),
	(2, 'assigned_program', 2, 'To All Computer Engineering Students', 'Please submit your Accomplishment Report for the month of January, the deadline is on March 4, 2023', '2023-04-04 11:15:21'),
	(3, 'assigned_program', 2, 'To All Entrep Students', 'Please follow-up on your evaluation form with your company supervisors.', '2023-04-04 11:26:56'),
	(4, 'assigned_program', 2, 'To All BSTI Students', 'Please pass all your accomplishment reports for the month of January', '2023-04-04 11:32:32'),
	(5, 'all_program', 2, '', 'Please pass all your remaining documents', '2023-04-04 11:34:09'),
	(6, 'all_program', 2, '', 'Announcement to ALL BSIT STUDENTS\r\n\r\nPlease wear white T-Shirt on our graduation practice', '2023-04-04 11:36:03'),
	(7, 'selected_program', 37, 'sample selected courses', 'Csafsdfdf', '2023-04-04 16:04:57'),
	(8, 'selected_program', 37, 'dsf', 'fdf', '2023-04-04 16:05:32');
...
-- Dumping data for table db_bpsu_timesheet.announcement_program_tags: ~5 rows (approximately)

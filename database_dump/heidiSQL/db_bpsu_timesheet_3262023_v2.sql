...
-- Dumping data for table db_bpsu_timesheet.auth_item: ~49 rows (approximately)
INSERT INTO `auth_item` (`name`, `type`, `description`, `rule_name`, `data`, `created_at`, `updated_at`) VALUES
	...
	('menu-submission', 2, '', NULL, NULL, NULL, NULL),
...
-- Dumping data for table db_bpsu_timesheet.auth_item_child: ~79 rows (approximately)
INSERT INTO `auth_item_child` (`parent`, `child`) VALUES
	...
	('CompanySupervisor', 'menu-submission'),
...
-- Dumping data for table db_bpsu_timesheet.files: ~67 rows (approximately)
...
INSERT INTO `ref_document_type` (`id`, `title`, `type`, `auth_item_name`) VALUES
	(1, 'TRAINEES_EVALUATION', 'SENDER', 'CompanySupervisor'),
	(2, 'TRAINEES_EVALUATION', 'RECEIVER', 'OjtCoordinator'),
	(3, 'ACCOMPLISHMENT_REPORT', 'SENDER', 'Trainee'),
	(4, 'ACCOMPLISHMENT_REPORT', 'RECEIVER', 'OjtCoordinator'),
	(5, 'ACTIVITY_REMINDER', 'SENDER', 'CompanySupervisor'),
	(6, 'ACTIVITY_REMINDER', 'RECEIVER', 'Trainee');
...
-- Dumping data for table db_bpsu_timesheet.submission_thread: ~1 rows (approximately)
...
-- Dumping data for table db_bpsu_timesheet.user_timesheet: ~11 rows (approximately)

...
INSERT INTO `files` (`id`, `user_id`, `model_name`, `model_id`, `file_name`, `extension`, `file_hash`, `remarks`, `created_at`, `user_timesheet_time`, `user_timesheet_id`) VALUES
	...
	(32, 2, 'UserFacialRegister', 44, '6430cf9e0b5e2.png', 'png', '6430cf9e0b5e2.png', NULL, 1680920478, NULL, NULL),
	(33, 2, 'UserFacialRegister', 44, '6430cfa515fad.png', 'png', '6430cfa515fad.png', NULL, 1680920485, NULL, NULL),
	(34, 2, 'UserFacialRegister', 44, '6430cfaa7f2fb.png', 'png', '6430cfaa7f2fb.png', NULL, 1680920490, NULL, NULL),
	(35, 2, 'UserFacialRegister', 44, '6430cfb2b714e.png', 'png', '6430cfb2b714e.png', NULL, 1680920498, NULL, NULL),
	...
	(38, 2, 'UserFacialRegister', 44, '6430cfc234cab.png', 'png', '6430cfc234cab.png', NULL, 1680920514, NULL, NULL),
	(39, 2, 'UserFacialRegister', 44, '6430cfc64c66d.png', 'png', '6430cfc64c66d.png', NULL, 1680920518, NULL, NULL),
	(40, 2, 'UserFacialRegister', 44, '6430cfca4e112.png', 'png', '6430cfca4e112.png', NULL, 1680920522, NULL, NULL),
	...
	(79, 35, 'UserTimesheet', 35, '6431468760499.png', 'png', '6431468760499.png', NULL, 1680950919, '18:48:39', 2);
...
INSERT INTO `user` (`id`, `student_idno`, `student_year`, `student_section`, `ref_program_id`, `ref_program_major_id`, `ref_department_id`, `ref_position_id`, `fname`, `mname`, `sname`, `suffix`, `bday`, `sex`, `username`, `auth_key`, `password_hash`, `password_reset_token`, `email`, `mobile_no`, `tel_no`, `address`, `status`, `created_at`, `updated_at`, `verification_token`) VALUES
	...
	(44, '120993', 4, 'B', 3, 0, 1, NULL, 'Leonel', '', 'Bon', '', '2005-04-01', 'F', 'leonel123', '2rEZW-2L1SKXcGtQH4WUoRSCSOtMz1EF', '$2y$13$hQ3KE4HpFlUrel0XWtTUGuqeDlr83YfnQIb3ihm6sntTfPfbc0dBa', NULL, 'trainee2@gm.com', 912342403, '32535454344', '990 somewhere st.', 10, 0, 0, 'vlVLZ9RDQL34uLDqgL_Iz5RfWOG8MTEF_1680316868'),
...
INSERT INTO `user_timesheet` (`id`, `user_id`, `time_in_am`, `time_out_am`, `time_in_pm`, `time_out_pm`, `date`, `remarks`, `status`) VALUES
	(1, 35, NULL, NULL, '18:42:37', '18:48:13', '2023-04-08', NULL, 0),
	(2, 35, NULL, NULL, '18:48:39', NULL, '2023-04-08', NULL, 0);

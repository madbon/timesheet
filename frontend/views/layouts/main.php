...
<header>
    ...
    else
    {
        ...
        $menuItemsLeft = [
            ...
            [
                'label' => '<i class="fas fa-tasks"></i> Tasks '.($countTask['countTask'] ? '<i class="fas fa-paper-plane" style="color:#ffcd39;"></i>' : '<i class="fas fa-paper-plane" style="color:gray;"></i>').' '.($countReply['countTaskReplySeen'] ? '<i class="fas fa-comments" style="color:#ffcd39;"></i>' : '<i class="fas fa-comments" style="color:gray;"></i>').'', 'url' => ['/submission-thread/index'], 'active' => Yii::$app->controller->id == "submission-thread" ? true : false,
